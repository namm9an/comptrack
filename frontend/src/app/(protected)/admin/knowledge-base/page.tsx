...
function NewFormatEntry({ entry }: { entry: KBEntry }) {
  ...
  if (!isNewFormat) {
    return <LegacyFormatEntry entry={entry} />;
  }
...
function LegacyFormatEntry({ entry }: { entry: KBEntry }) {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {fetching ? (
            ...
            <div className="space-y-4">
              {displayed.map((entry) => (
                <NewFormatEntry key={entry.id} entry={entry} />
              ))}
            </div>
          )}
        </div>
